	...
	<div id="page" class="site">
		...
		<?php if ( get_header_image() ) { ?>
				...
				<div class="site-logo">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
						<div class="screen-reader-text">
							<?php printf( esc_html__('Go to the home page of %1$s', ''), $site_title ); ?>
						</div>
						<?php
						if ( has_site_icon() ) {
			...
			<nav id="site-navigation" class="main-navigation" role="navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'architects_artists_portfolio' ); ?>

				</button><?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'primary-menu', 'menu-class' => 'nav-menu' ) ); ?>
